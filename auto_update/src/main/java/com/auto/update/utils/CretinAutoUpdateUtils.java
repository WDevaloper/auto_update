...
import com.auto.update.common.Constants;
import com.auto.update.interfaces.ForceExitCallBack;
import com.auto.update.model.LibraryUpdateEntity;
import com.auto.update.model.UpdateEntity;
import com.auto.update.view.ProgressView;
...
public class CretinAutoUpdateUtils {
    ...
    public static void installApkFile(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(context, context.getPackageName() + Constants.FILE_PROVIDER, file);
