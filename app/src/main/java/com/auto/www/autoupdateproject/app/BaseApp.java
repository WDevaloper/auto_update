package com.auto.www.autoupdateproject.app;

import android.app.Application;

import com.auto.www.autoupdateproject.BaseReq;
import com.auto.www.autoupdateproject.model.UpdateModel2;
import com.blankj.utilcode.util.Utils;
import com.auto.www.autoupdateproject.CustomActivity;
import com.auto.www.autoupdateproject.R;
import com.auto.update.model.TypeConfig;
import com.auto.update.model.UpdateConfig;
import com.auto.www.autoupdateproject.utils.OkHttp3Connection;
import com.auto.update.utils.AppUpdateUtils;
import com.auto.update.utils.SSLUtils;
...
public class BaseApp extends Application {
    ...
    public void onCreate() {
        ...
        UpdateConfig updateConfig = new UpdateConfig()
                ...
                .setBaseUrl("http://api-test.youbesun.com/v1/app/version")//当dataSourceType为DATA_SOURCE_TYPE_URL时，配置此接口用于获取更新信息
                ...
                .setRequestParams(new BaseReq().getParam())//当dataSourceType为DATA_SOURCE_TYPE_URL时，设置请求的请求参数
                ...
                .setModelClass(new UpdateModel2());
        //初始化
